...
export default function Home() {
  ...
  return (
    <div>
      ...
      >
        <Headphones size={28} color="#f59e0b" />
        <div style={{ flex: 1 }}>
          <div style={{ fontWeight: 600, fontSize: 15, marginBottom: 2 }}>👨‍🍳 Collocation Chef</div>
          <div style={{ fontSize: 13, color: 'var(--text-secondary)' }}>
            Pick the right verb — make / do / take / have / give — for natural English collocations.
          </div>
        </div>
        <span style={{
          padding: '6px 14px', borderRadius: 8, background: '#f59e0b',
      ...
      >
        <Headphones size={28} color="#0ea5e9" />
        <div style={{ flex: 1 }}>
          <div style={{ fontWeight: 600, fontSize: 15, marginBottom: 2 }}>❓ WH-Question Formation</div>
          <div style={{ fontSize: 13, color: 'var(--text-secondary)' }}>
            Hear an answer → speak the question. Jeopardy-style drill for auxiliaries &amp; word order.
          </div>
        </div>
        <span style={{
          padding: '6px 14px', borderRadius: 8, background: '#0ea5e9',
      ...
      >
        <Headphones size={28} color="#8b5cf6" />
        <div style={{ flex: 1 }}>
          <div style={{ fontWeight: 600, fontSize: 15, marginBottom: 2 }}>🎧 Pause &amp; Predict</div>
          <div style={{ fontSize: 13, color: 'var(--text-secondary)' }}>
            Hear a sentence cut off early — predict the final 1-3 word chunk.
          </div>
        </div>
        <span style={{
          padding: '6px 14px', borderRadius: 8, background: '#8b5cf6',
      ...
      >
        <PenTool size={28} color="#14b8a6" />
        <div style={{ flex: 1 }}>
          <div style={{ fontWeight: 600, fontSize: 15, marginBottom: 2 }}>🔠 Article Drill</div>
          <div style={{ fontSize: 13, color: 'var(--text-secondary)' }}>
            Tap a / an / the / ∅ to fill the blank — 8 sentences with rule hints.
          </div>
        </div>
        <span style={{
          padding: '6px 14px', borderRadius: 8, background: '#14b8a6',
      ...
      >
        <Headphones size={28} color="#8b5cf6" />
        <div style={{ flex: 1 }}>
          <div style={{ fontWeight: 600, fontSize: 15, marginBottom: 2 }}>↗↘ Intonation Arrow</div>
          <div style={{ fontSize: 13, color: 'var(--text-secondary)' }}>
            Listen and tap Rising, Falling, or Rise-Fall — train your ear for final intonation.
          </div>
        </div>
        <span style={{
          padding: '6px 14px', borderRadius: 8, background: '#8b5cf6',
