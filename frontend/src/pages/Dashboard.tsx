...
import { AchievementsPanel, GrammarTrend, ListeningProgress, MistakeJournal, MistakeReviewDrill, SessionAnalytics, SkillsRadarChart, SpeakingConfidence, WeeklyReport } from '../components/dashboard';
