...
import { AchievementsPanel, GrammarTrend, ListeningProgress, MistakeJournal, MistakeReviewDrill, PronunciationProgress, SessionAnalytics, SkillsRadarChart, SpeakingConfidence, WeeklyReport } from '../components/dashboard';
