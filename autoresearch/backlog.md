...
- [ ] Add unit tests for conversation DAL (`app/dal/conversation.py`) — test create_conversation, add_message, update_message_feedback, format_history_text
- [ ] Add unit tests for pronunciation DAL (`app/dal/pronunciation.py`) — test get_sentences_from_conversations, save_attempt, get_history
- [ ] Add unit tests for vocabulary DAL (`app/dal/vocabulary.py`) — test get_words_by_topic, save_words, get_due_word_ids, build_quiz, update_progress, get_progress
